...
<head>
    ...
    <title>Dashboard | Engineer - Admin Staff</title>
...
<body class="darklayout">
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar">
                <div class="sidebar-header">
                    <a href="#"><img src="<?php echo base_url(); ?>uploads/staff/1.jpg" alt="" />
                    </a>
                    <h3><?=$staff['nama_lengkap'];?></h3>
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>index.php/Musharaf/LawhatAlqiada" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                <i class="fa big-icon fa-home"></i> 
                                <span class="mini-dn">Home</span> 
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>index.php/Musharaf/WazifatShaghira" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                <i class="fa big-icon fa-graduation-cap"></i> 
                                <span class="mini-dn">Job Vacancy</span> 
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>index.php/Musharaf/TalabEamal" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                <i class="fa big-icon fa-users"></i> 
                                <span class="mini-dn">Job Seeker</span> 
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>index.php/Musharaf/Sharika" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                <i class="fa big-icon fa-university"></i>
                                 <span class="mini-dn">Company</span> 
                            </a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                ...
                                                <span class="admin-name"><?=$staff['nama_lengkap'];?></span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcome-heading">
                                            <h2>Thanks for Visits Destop</h2>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcome-heading">
                                            <h2>Thanks for Visits Mobile</h2>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        <p>Copyright &#169; 2018 Brama All rights reserved. Template by Brama.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url(); ?>assets/admin/js/flot/Chart.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/flot/flot-active.js"></script>
    <!-- map JS
		============================================ -->
    <script src="<?php echo base_url(); ?>assets/admin/js/map/raphael.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/map/jquery.mapael.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/map/france_departments.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/map/world_countries.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/map/usa_states.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/map/map-active.js"></script>
    <!-- data table JS
		============================================ -->
